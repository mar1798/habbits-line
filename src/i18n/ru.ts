...
export const ru = {
  ...
  // Три состояния подсказки о бэкапе, см. lib/backup-status.ts. Дата уже отформатирована
  // по локали вызывающим экраном.
  settings_backup_never: 'Резервной копии ещё не было — вместе с приложением уйдут и данные.',
  settings_backup_last: 'Последняя копия: {date}.',
  settings_backup_stale: 'Последняя копия: {date}, {count} {days} назад — пора сделать новую.',
  ...
  settings_about_version: 'Версия {version} ({build})',
  settings_about_privacy: 'Политика конфиденциальности',
