...
export const en: Record<keyof typeof ru, string> = {
  ...
  habit_form_name_taken: 'A habit with this name already exists',
  ...
  category_form_name_taken: 'A category with this name already exists',
  ...
  settings_currency_prefix: 'Before',
  settings_currency_suffix: 'After',
  settings_currency_hint: 'Up to three characters. An empty field shows the bare number. Example: {example}',
  settings_data: 'Data',
  ...
  settings_about_version: 'Version {version} ({build})',
